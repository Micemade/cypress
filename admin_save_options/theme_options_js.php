...
$smooth_wheelscroll		= isset($of_cypress['smooth_wheelscroll']) ? $of_cypress['smooth_wheelscroll'] : true;
...
if( $smooth_wheelscroll ) {
	...
	//echo '$c(function() { jQuery.scrollSpeed(120, 800); }); ';
	echo '$c("body").smoothScroll(); ';
