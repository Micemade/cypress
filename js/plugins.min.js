...
!function(t){function e(){n()||(viewportTop=t(window).scrollTop(),windowHeight=t(window).height(),viewportBottom=windowHeight+viewportTop,t(window).width()&&t('[data-parallax="true"]').each(function(){parentTop=t(this).parent().offset().top,shift=viewportTop-parentTop,speed=parseFloat(t(this).attr("data-speed")),distance=shift*speed,sym="up"===t(this).attr("data-direction")?"":"-",t(this).css("transform","translate3d(0, "+sym+distance+"px,0 ) scale("+(1+speed)+")")}))}function n(){return"ontouchstart"in window||"onmsgesturechange"in window}t(document).ready(function(){function t(){requestAnimationFrame(t),e()}t()})}(jQuery);	