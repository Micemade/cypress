...
}// end func. video_shortcode
}
add_action( 'init', 'video_shortcode' );
//
/**
 *	remove_video_shortcode - remove video shortcode from content.
 *
 */
...
/**
 *	video_thumbs() - retrieve video screenshot image from video hosted on varoius video host services.
 *
 */
