...
class Widget_Latest_Post_Images extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'latest-image-widget', 'description' => __('A widget displaying latest content images.', 'cypress') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'latest-content-images' );

		/* Create the widget. */
		parent::__construct( 'latest-content-images', __('Latest content images', 'cypress'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 
			'title' => __('latest content', 'cypress'),
			'num' => 6,
			'width'=>'45%',
			'image_size' => 'thumbnail' ,
			'types'  => 'post'
		...
		*/
		...
		<p>
			<label for="<?php echo $this->get_field_id('types'); ?>"><?php echo __( 'Post type(s):','cypress' ); ?></label>
