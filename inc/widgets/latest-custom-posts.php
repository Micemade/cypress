...
class latest_custom_posts extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		// Widget options
		$title 	 = apply_filters('widget_title',  isset($instance['title']) ? $instance['title'] : __('Recent','cypress') ); // Title		
	...
	function form( $instance ) {	
			...
			<p>
				<label for="<?php echo $this->get_field_id('title'); ?>"><?php echo __( 'Title:','cherry' ); ?></label>
				<input id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" class="widefat" />
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id('types'); ?>"><?php echo __( 'Post type(s):','cherry' ); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('number'); ?>"><?php echo __( 'Number of items for display:', 'cherry' ); ?></label>
				<input id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo $number; ?>" size="3" />
			</p>
						
			<p>
				<label for="<?php echo $this->get_field_id('img_width'); ?>"><?php echo __( 'Image width', 'cherry' ); ?></label>
