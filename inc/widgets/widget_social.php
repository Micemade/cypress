...
//add_action('wp_head','cypressSocialWidgetCss');
...
class as_SocialWidget extends WP_Widget {
	...
	function __construct() {
		//Settings
		$widget_ops = array('classname'=>'as_socialwidget','description'=>__('Display social icons on your site.','cypress'));
		
		//Controll settings
		$control_ops = array('id_base' => 'as_socialwidget');
		
		//Create widget
		parent::__construct('as_socialwidget',__('Social Widget','cypress'),$widget_ops,$control_ops);
	...
	function widget($args,$instance) {
		...
		?>
			...
			<?php if($rss == 1) : ?>
				<a href="<?php bloginfo('rss2_url'); ?>" target="_blank" title="RSS"><span class="fs" aria-hidden="true" data-icon="&#xe112;"></span></a>
			<?php endif; ?>
			
			<?php if($facebook) : ?>
				<a href="<?php echo $facebook; ?>" target="_blank" title="Facebook"><span class="fs" aria-hidden="true" data-icon="&#xe10d;"></span></a>
			<?php endif; ?>		
						
			<?php if($twitter) : ?>
				<a href="<?php echo $twitter; ?>" target="_blank" title="Twitter"><span class="fs" aria-hidden="true" data-icon="&#xe111;"></span></a>
			<?php endif; ?>	
			
			<?php if($linkedin) : ?>
				<a href="<?php echo $linkedin; ?>" target="_blank" title="Linkedin"><span class="fs" aria-hidden="true" data-icon="&#xe141;"></span></a>
			<?php endif; ?>	
			
			<?php if($gplus) : ?>
				<a href="<?php echo $gplus; ?>" target="_blank" title="Google Plus"><span class="fs" aria-hidden="true" data-icon="&#xe109;"></span></a>
			<?php endif; ?>
					
			<?php if($youtube) : ?>
				<a href="<?php echo $youtube; ?>" target="_blank" title="YouTube"><span class="fs" aria-hidden="true" data-icon="&#xe115;"></span></a>
			<?php endif; ?>
						
			<?php if($flickr) : ?>
				<a href="<?php echo $flickr; ?>" target="_blank" title="Flickr"><span class="fs" aria-hidden="true" data-icon="&#xe11e;"></span></a>
			<?php endif; ?>			

			<?php if($vimeo) : ?>
				<a href="<?php echo $vimeo; ?>" target="_blank" title="Vimeo"><span class="fs" aria-hidden="true" data-icon="&#xe118;"></span></a>
			<?php endif; ?>
			
			<?php if($pinterest) : ?>
				<a href="<?php echo $pinterest; ?>" target="_blank" title="Pinterest"><span class="fs" aria-hidden="true" data-icon="&#xe148;"></span></a>
			<?php endif; ?>
			
			<?php if($dribbble) : ?>
				<a href="<?php echo $dribbble; ?>" target="_blank" title="Dribbble"><span class="fs" aria-hidden="true" data-icon="&#xe123;"></span></a>
			<?php endif; ?>	
			
			<?php if($forrst) : ?>
				<a href="<?php echo $forrst; ?>" target="_blank" title="Forrst"><span class="fs" aria-hidden="true" data-icon="&#xe125;"></span></a>
			<?php endif; ?>		

			<?php if($instagram) : ?>
				<a href="<?php echo $instagram; ?>" target="_blank" title="Instagram"><span class="fs" aria-hidden="true" data-icon="&#xe10e;"></span></a>
			<?php endif; ?>	

			<?php if($github) : ?>
				<a href="<?php echo $github; ?>" target="_blank" title="Github"><span class="fs" aria-hidden="true" data-icon="&#xe12c;"></span></a>
			<?php endif; ?>	
			
			<?php if($picassa) : ?>
				<a href="<?php echo $picassa; ?>" target="_blank" title="Picassa"><span class="fs" aria-hidden="true" data-icon="&#xe11f;"></span></a>
			<?php endif; ?>	
			
			<?php if($skype) : ?>
				<a href="<?php echo $skype; ?>" target="_blank" title="Skype"><span class="fs" aria-hidden="true" data-icon="&#xe13f;"></span></a>
			<?php endif; ?>	
	...
	?>
		<!-- TITLE -->
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php echo __('Title:','cypress'); ?></label>
			<br />
			<input type="text" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" value="<?php echo $instance['title']; ?>" class="widefat" />
		</p>		
		<!-- RSS -->
		<p>
			<label for="<?php echo $this->get_field_id('rss'); ?>"><?php echo __('RSS link:','cypress'); ?></label>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" id="<?php echo $this->get_field_id('rss'); ?>" name="<?php echo $this->get_field_name('rss'); ?>" <?php if($instance['rss'] == 1): ?> checked="checked" <?php endif; ?> value="1" /> <?php echo __('Yes','cypress'); ?>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" id="<?php echo $this->get_field_id('rss'); ?>" name="<?php echo $this->get_field_name('rss'); ?>" <?php if($instance['rss'] == 0): ?> checked="checked" <?php endif; ?> value="0" /> <?php echo __('No','cypress'); ?>
		</p>
		<!-- Facebook -->
		<p>
			<label for="<?php echo $this->get_field_id('facebook'); ?>"><?php echo __('Facebook link:','cypress'); ?></label>
			<br />
		...
		<!-- Twitter -->
		<p>
			<label for="<?php echo $this->get_field_id('twitter'); ?>"><?php echo __('Twitter link:','cypress'); ?></label>
			<br />
		...
		<!-- LinkedIn -->
		<p>
			<label for="<?php echo $this->get_field_id('linkedin'); ?>"><?php echo __('LinkedIn link:','cypress'); ?></label>
			<br />
		...
		<!-- Google Plus -->
		<p>
			<label for="<?php echo $this->get_field_id('gplus'); ?>"><?php echo __('Google Plus link:','cypress'); ?></label>
			<br />
		...
		<!-- Youtube -->
		<p>
			<label for="<?php echo $this->get_field_id('youtube'); ?>"><?php echo __('Youtube link:','cypress'); ?></label>
			<br />
		...
		<!-- Flickr -->
		<p>
			<label for="<?php echo $this->get_field_id('flickr'); ?>"><?php echo __('Flickr link:','cypress'); ?></label>
			<br />
		...
		<!-- Vimeo -->
		<p>
			<label for="<?php echo $this->get_field_id('vimeo'); ?>"><?php echo __('Vimeo link:','cypress'); ?></label>
			<br />
		...
		<!-- Pinterest -->
		<p>
			<label for="<?php echo $this->get_field_id('pinterest'); ?>"><?php echo __('Pinterest link:','cypress'); ?></label>
			<br />
		...
		<!-- Dribbble -->
		<p>
			<label for="<?php echo $this->get_field_id('dribbble'); ?>"><?php echo __('Dribbble link:','cypress'); ?></label>
			<br />
		...
		<!-- Forrst -->
		<p>
			<label for="<?php echo $this->get_field_id('forrst'); ?>"><?php echo __('Forrst link:','cypress'); ?></label>
			<br />
		...
		<!-- Instagram -->
		<p>
			<label for="<?php echo $this->get_field_id('instagram'); ?>"><?php echo __('Instagram link:','cypress'); ?></label>
			<br />
		...
		<!-- Github -->
		<p>
			<label for="<?php echo $this->get_field_id('github'); ?>"><?php echo __('Github link:','cypress'); ?></label>
			<br />
		...
		<!-- Picassa -->
		<p>
			<label for="<?php echo $this->get_field_id('picassa'); ?>"><?php echo __('Picassa link:','cypress'); ?></label>
			<br />
		...
		<!-- Skype -->
		<p>
			<label for="<?php echo $this->get_field_id('skype'); ?>"><?php echo __('Skype link:','cypress'); ?></label>
			<br />
