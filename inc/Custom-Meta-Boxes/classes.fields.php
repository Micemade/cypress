...
abstract class AS_Field {
	...
	public function display() {
		...
		if ( $this->args['repeatable'] ) {
			...
			<button class="button repeat-field"><?php esc_html_e( 'Add New', 'as' ); ?></button>
...
class AS_File_Field extends AS_Field {
	...
	public function html() { 
		...
		<div class="as-file-wrap" <?php echo 'data-type="' . esc_attr( $data_type ) . '"'; ?>>
			...
			<button class="button as-file-upload <?php echo esc_attr( $this->get_value() ) ? 'hidden' : '' ?>">
				<?php esc_html_e( 'Add File', 'as' ); ?>
			</button>
	...
	public function html() { 
		...
		if ( $this->is_placeholder() ) 	{
			...
			<script>
				...
				as_wysiwyg_editors.<?php echo $field_id; ?> = '<?php echo $editor; ?>';
			</script>
...
class AS_Select extends AS_Field {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'select2', trailingslashit( AS_URL ) . 'js/select2/select2.js', array( 'jquery' ) );
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( 'select2', trailingslashit( AS_URL ) . 'js/select2/select2.css' );
	}
	...
	public function output_field() {
		...
		>
			...
			<?php if ( ! empty( $this->args['allow_none'] ) ) : ?>
				<option value=""><?php echo esc_html_x( 'None', 'select field', 'as' ) ?></option>
			<?php endif; ?>
	...
	public function output_script() {
		...
		<script type="text/javascript">
			...
			(function($) {
				...
				options.placeholder = <?php echo json_encode( __( 'Type to search', 'as' ) ) ?>;
	...
	public function display() {
		...
		if ( $this->args['repeatable'] ) {
			...
			$this->value = ''; ?>
				...
				<button class="button repeat-field"><?php esc_html_e( 'Add New Group', 'as' ); ?></button>
