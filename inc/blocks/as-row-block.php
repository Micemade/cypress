...
class AS_Row_Block extends AQ_Block {
	...
	function form($instance) {
		...
		<p class="empty-row">
		<?php echo __('ROW BLOCK', 'cypress'); ?>
		<a class="row-edit" title="Edit Settings" href="#"><?php echo __('Row settings','cypress')?></a>
		</p>
		...
		<div class="row-special-settings">
			...
			<div class="description row_color_picker fourth">
				...
				<?php echo __('Titles color','cypress'); ?>
				</label><br />
				...
				<?php echo __('Text color','cypress'); ?>
				</label><br />
				...
				<?php echo __('Links color','cypress'); ?>
				</label><br />
				...
				<?php echo __('Overlay color','cypress'); ?>
				</label><br />
			...
			<!--
			<div class="description image_upload fourth">
				<label for="<?php// echo $this->get_field_id('image') ?>">
				<?php //echo __('Row background image','cypress'); ?>
				</label>
				<?php //echo aq_field_upload('image', $this->block_id, $image, 'image') ;?>
			...
			<div class="description fourth">
				...
				<label for="<?php echo $this->get_field_id('full_width') ?>"><?php echo __('Full width content in row ?','cypress');?></label><br />
				<?php echo aq_field_checkbox('full_width', $this->block_id,  $defaults['full_width']) ;?>
			
				<div class="clearfix"></div>
				
				<label for="<?php echo $this->get_field_id('eq_heights') ?>"><?php echo __('Equalize inner blocks heights ?','cypress');?></label><br />
		...
		if(isset($template_id)) {
			...
			echo '<li id="template-block-'.$number.'" class="block block-as_row_block '.$size.'">',
					'<div class="block-settings-row cf" id="block-settings-'.$number.'">',
						'<p class="empty-row">',
							__('ROW BLOCK', 'cypress'),
							'<span class="block-id-menu" id="">ID: aq-block-'. $number .'</span>',
							'<a class="row-edit" title="Edit Settings" href="#">'. __('Row settings','cypress').'</a>',
						'</p>';	
			?>
	...
	function before_block($instance) {
		...
		if(  $bck_image || $bck_repeat || $back_size || isset($padd_top) || isset($padd_bott) || $links_color || $text_color	|| $titles_color ) {
			echo '<style> ';
		...
		echo $instance['full_width'] ? '<div class="full-width">' : '<div class="grid-container">';
