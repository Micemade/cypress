...
class AS_Button extends AQ_Block {
	...
	function block($instance) {
		...
		if( $button_color || $text_color || $border_width || $border_color || $button_margin ) {
		
			echo '<style>';
			
			echo $button_margin ? '#'.$block_id .'{ padding: '.$button_margin.'em; }' : '';
			
			echo '#'.$block_id .' a.button {';
		...
		<div id="<?php echo $block_id; ?>" class="button-block">
			...
			<div class="bottom-block-link <?php echo $button_float; ?>">
				...
				<a href="<?php echo $button_url ; ?>" title="<?php echo esc_attr($button_label); ?>" class="button <?php echo $button_style; ?>">
